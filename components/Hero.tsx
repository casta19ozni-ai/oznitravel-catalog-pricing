...
export const Hero: React.FC<HeroProps> = ({ onCtaClick, onExploreClick }) => {
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      {/* Fondo con superposición optimizada */}
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        {/* Botones con llamados a la acción específicos para grupos */}
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-6 opacity-60 text-[10px] uppercase tracking-[0.3em] font-medium text-white">
          <span className="flex items-center gap-2">💎 Respaldo Travorium</span>
          <span className="text-ozni-gold">|</span>
          <span className="flex items-center gap-2">⚓ Logística Crew On Shore</span>
          <span className="text-ozni-gold">|</span>
          <span className="flex items-center gap-2">🌴 Punta Cana • Cartagena • Europa</span>
        </div>
      </div>
    </section>
  );
